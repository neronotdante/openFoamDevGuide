...
#include "timeDependentVelocityFvPatchVectorField.H"
...
Foam::scalar Foam::timeDependentVelocityFvPatchVectorField::t() const
{
...
timeDependentVelocityFvPatchVectorField
(
    const timeDependentVelocityFvPatchVectorField& ptf,
    const fvPatch& p,
    const DimensionedField<vector, volMesh>& iF,
...
void Foam::timeDependentVelocityFvPatchVectorField::autoMap
(
...
void Foam::timeDependentVelocityFvPatchVectorField::rmap
(
...
)
{
    ...
    const timeDependentVelocityFvPatchVectorField& tiptf =
        refCast<const timeDependentVelocityFvPatchVectorField>(ptf);

    fieldData_.rmap(tiptf.fieldData_, addr);
}


void Foam::timeDependentVelocityFvPatchVectorField::reset
(
    const fvPatchVectorField& ptf
)
{
...
void Foam::timeDependentVelocityFvPatchVectorField::updateCoeffs()
{
    if (updated())
    {
        return;
...
void Foam::timeDependentVelocityFvPatchVectorField::write
(
    Ostream& os
) const
{
